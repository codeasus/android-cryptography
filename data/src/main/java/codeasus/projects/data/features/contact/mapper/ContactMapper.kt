...
class ContactMapper : Mapper<ContactEntity, Contact> {
    override fun mapToModel(entity: ContactEntity): Contact {
        return Contact(entity.phoneNumber, entity.displayName, entity.rawID, entity.lookupKey)
    }

    override fun mapToEntity(model: Contact): ContactEntity {
        return ContactEntity(0, model.phoneNumber, model.displayName, model.rawID, model.lookupKey)
    }
}